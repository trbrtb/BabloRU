...
AOS.init({
	disable: 'mobile', // На каких устройствах не показывать анимацию: 'phone', 'tablet', 'mobile'
	...
	once: false, // Повторение анимации
	mirror: true, // whether elements should animate out while scrolling past them
	anchorPlacement: 'top-bottom', // С какого положения страицы начинать анимацию
});
